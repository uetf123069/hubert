        ...
        <tr>
            <td data-bg="Background" align="center" background="{{asset('email/bg-3.jpg')}}" style="background-size:cover; background-position:top;">
                <table class="table600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="center">
                            <table data-border-top-color="Border Top" style="border-top:3px solid #91c444; border-radius:4px;box-shadow: 0px 3px 0px #bdc3c7;" bgcolor="#FFFFFF" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                    ...
                    <tr>
                        <td align="center">
                            <table align="center" bgcolor="#FFFFFF" style="box-shadow: 0px 3px 0px #bdc3c7; border-radius:4px;" width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <table align="center" class="table-inner" width="500" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table width="25" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td data-border-bottom-color="Main Color" height="20" style="border-bottom:2px solid #91c444;"></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td data-link-style="text-decoration:none; color:#91c444;" data-link-color="Content Link" mc:edit="content" data-color="Main Text" data-size="Main Text" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:30px;">
                                                    Hi, {{$email_data['provider']->first_name}} {{$email_data['provider']->last_name}}. Your request is cancelled by {{$email_data['user']->first_name}} {{$email_data['user']->last_name}}. please try again later or search new people around you.
                                                    <br>
                                ...
                                <!-- button -->
                                <tr>
                                    <td data-bgcolor="Content BG" align="center" bgcolor="#ecf0f1">
                                                    ...
                                                    <table data-bgcolor="Main Color" align="center" bgcolor="#91c444" border="0" cellspacing="0" cellpadding="0" style=" border-radius:30px; box-shadow: 0px 2px 0px #dedfdf;">
                                                        <tr>
                                                            <td mc:edit="button" height="55" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:16px; color:#7f8c8d; line-height:30px; font-weight: bold;padding-left: 25px;padding-right: 25px;">
                                                                <a href="http://xuber.appoets.co/" style="color:#ffffff;text-decoration:none;" data-color="Button Link">{{Helper::tr('find_new')}}</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                            ...
                            <table bgcolor="#ecf0f1" style="box-shadow: 0px 3px 0px #bdc3c7; border-radius:4px;" class="table3-3" align="left" width="183" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td data-link-style="text-decoration:none; color:#3b3b3b;" data-link-color="Text Link" mc:edit="button-1" height="50" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#3b3b3b; line-height:30px;padding-left: 25px;padding-right: 25px;">
                                        <a href="{{route('user.dashboard')}}" target="_blank" style="color:#3b3b3b;text-decoration:none;" data-color="Text Link">{{Helper::tr('need_help')}}</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table bgcolor="#ecf0f1" style="box-shadow: 0px 3px 0px #bdc3c7; border-radius:4px;" class="table3-3" align="left" width="183" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td data-link-style="text-decoration:none; color:#3b3b3b;" data-link-color="Text Link" mc:edit="button-2" height="50" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#3b3b3b; line-height:30px;padding-left: 25px;padding-right: 25px;">
                                        <a href="{{URL::to('/')}}" target="_blank" style="color:#3b3b3b;text-decoration:none;" data-color="Text Link">{{Helper::tr('search_new')}}</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table bgcolor="#ecf0f1" style="box-shadow: 0px 3px 0px #bdc3c7; border-radius:4px;" class="table3-3" align="right" width="183" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td data-link-style="text-decoration:none; color:#3b3b3b;" data-link-color="Text Link" mc:edit="button-3" height="50" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#3b3b3b; line-height:30px;padding-left: 25px;padding-right: 25px;">
                                        <a href="{{URL::to('/')}}" target="_blank" style="color:#3b3b3b;text-decoration:none;" data-color="Text Link">{{Helper::tr('visit_website')}}</a>
                                    </td>
                                </tr>
                            </table>
