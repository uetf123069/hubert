    ...
    <ul class="nav navbar-nav navbar-right hidden-xs">
        ...
        <li>
            <a href="javascript:;" data-toggle="dropdown">
                <div class="ad-pro-img"><img src="{{Auth::guard('admin')->user()->picture? Auth::guard('admin')->user()->picture : asset('user_default.png')}}" class="header-avatar img-circle ml10" alt="user" title="user"></div>
